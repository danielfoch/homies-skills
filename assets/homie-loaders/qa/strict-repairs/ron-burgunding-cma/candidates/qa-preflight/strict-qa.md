...
|---|---|---:|---:|---:|---:|---|
| `ron-burgunding-cma` | FAIL | 84px | 3.606px | 1.0761% | 10.0332% | pending |

## ron-burgunding-cma — FAIL
...
Full-size contact: `assets/homie-loaders/qa/strict-repairs/ron-burgunding-cma/candidates/qa-preflight/contacts/ron-burgunding-cma-source-full.png`

128px contact: `assets/homie-loaders/qa/strict-repairs/ron-burgunding-cma/candidates/qa-preflight/contacts/ron-burgunding-cma-source-128.png`

GIF contact: `assets/homie-loaders/qa/strict-repairs/ron-burgunding-cma/candidates/qa-preflight/contacts/ron-burgunding-cma-gif-128.png`
