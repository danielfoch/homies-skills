...
Full-size contact: `assets/homie-loaders/qa/strict-repairs/robin-hooding-manager/candidates/qa/contacts/robin-hooding-manager-source-full.png`

128px contact: `assets/homie-loaders/qa/strict-repairs/robin-hooding-manager/candidates/qa/contacts/robin-hooding-manager-source-128.png`

GIF contact: `assets/homie-loaders/qa/strict-repairs/robin-hooding-manager/candidates/qa/contacts/robin-hooding-manager-gif-128.png`

Failures: none

Warnings: none

Manual notes: Inspected all four 627px authored cells, all four 128px cells, and the reversible six-frame GIF contact. Exactly one bow, one continuous string, one nocked arrow, and one arrowhead remain readable in every phase. The nock and complete arrow retreat 15px toward the cheek while bow tips, face core, bow hand, body, crop, and scale remain fixed. The muted burgundy upper garment and hat, olive leggings, tan leather, and red feather come from one frame-shared deterministic recolour with unchanged alpha geometry.
