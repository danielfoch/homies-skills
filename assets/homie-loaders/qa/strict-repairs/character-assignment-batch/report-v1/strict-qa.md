...
|---|---|---:|---:|---:|---:|---|
| `barbie-ing-listings` | FAIL | 65px | 7.28px | 3.3789% | 10.0182% | recorded: pass |
...
| `harvey-spectering-manager` | FAIL | 64px | 2.828px | 0.2019% | 4.0218% | recorded: pass |

## barbie-ing-listings — FAIL
...
Full-size contact: `qa/strict-repairs/character-assignment-batch/report-v1/contacts/barbie-ing-listings-source-full.png`

128px contact: `qa/strict-repairs/character-assignment-batch/report-v1/contacts/barbie-ing-listings-source-128.png`

GIF contact: `qa/strict-repairs/character-assignment-batch/report-v1/contacts/barbie-ing-listings-gif-128.png`

Failures: `FIXED_PLATE_REDRAW_RESIDUAL`, `STATIONARY_REGION_DRIFT:fixed-female-face-and-torso`
...
|---|---:|---:|
| fixed-female-face-and-torso | 5.6743% | 0.0% |
...
Full-size contact: `qa/strict-repairs/character-assignment-batch/report-v1/contacts/pulp-fictioning-manager-source-full.png`

128px contact: `qa/strict-repairs/character-assignment-batch/report-v1/contacts/pulp-fictioning-manager-source-128.png`

GIF contact: `qa/strict-repairs/character-assignment-batch/report-v1/contacts/pulp-fictioning-manager-gif-128.png`
...
Full-size contact: `qa/strict-repairs/character-assignment-batch/report-v1/contacts/michael-burrying-manager-source-full.png`

128px contact: `qa/strict-repairs/character-assignment-batch/report-v1/contacts/michael-burrying-manager-source-128.png`

GIF contact: `qa/strict-repairs/character-assignment-batch/report-v1/contacts/michael-burrying-manager-gif-128.png`
...
## harvey-spectering-manager — FAIL
...
Full-size contact: `qa/strict-repairs/character-assignment-batch/report-v1/contacts/harvey-spectering-manager-source-full.png`

128px contact: `qa/strict-repairs/character-assignment-batch/report-v1/contacts/harvey-spectering-manager-source-128.png`

GIF contact: `qa/strict-repairs/character-assignment-batch/report-v1/contacts/harvey-spectering-manager-gif-128.png`

Failures: `SIGNATURE_ACTION_MASK_CHANGE_TOO_SMALL`, `UPPER_BODY_IDENTITY_DRIFT`, `STATIONARY_REGION_DRIFT:fixed-manager-head-and-tie`
...
| Cell | Margin | Foreground | Components (significant/tiny) | Artifact flags |
|---:|---:|---:|---:|---|
| 0 | 64px | 41502px | 1 (1/0) | none |
| 1 | 64px | 41528px | 1 (1/0) | none |
| 2 | 64px | 41584px | 1 (1/0) | none |
| 3 | 64px | 41547px | 1 (1/0) | none |

| Transition | Mask XOR | Silhouette p95 | Centroid | Registration shift | Residual | Upper NCC |
|---:|---:|---:|---:|---:|---:|---:|
| 0→1 | 0.1204% | 1.736px | 0.059px | 0.0px | 3.2162% | 0.9581 |
| 1→2 | 0.2019% | 2.828px | 0.123px | 0.0px | 4.0218% | 0.9238 |
| 2→3 | 0.1034% | 2.212px | 0.083px | 0.0px | 3.1741% | 0.9529 |

| Stationary region | Max change | Allowed |
|---|---:|---:|
| fixed-manager-head-and-tie | 3.1896% | 0.0% |
