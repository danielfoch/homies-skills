...
|---|---|---:|---:|---:|---:|---|
| `gatsbying-manager` | FAIL | 86px | 3.162px | 1.0845% | 5.2292% | pending |

## gatsbying-manager — FAIL
...
Full-size contact: `assets/homie-loaders/qa/strict-repairs/gatsbying-manager/candidates/qa-preflight/contacts/gatsbying-manager-source-full.png`

128px contact: `assets/homie-loaders/qa/strict-repairs/gatsbying-manager/candidates/qa-preflight/contacts/gatsbying-manager-source-128.png`

GIF contact: `assets/homie-loaders/qa/strict-repairs/gatsbying-manager/candidates/qa-preflight/contacts/gatsbying-manager-gif-128.png`
