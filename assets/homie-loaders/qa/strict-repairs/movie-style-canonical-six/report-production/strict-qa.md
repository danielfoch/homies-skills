...
|---|---|---:|---:|---:|---:|---|
| `rambo-ing-manager` | PASS | 65px | 7.211px | 1.6271% | 2.7051% | recorded: pass |
| `godfathering-reports` | PASS | 65px | 0.0px | 0.0% | 0.379% | recorded: pass |
| `pulp-fictioning-reports` | PASS | 65px | 11.402px | 5.1337% | 8.7212% | recorded: pass |
| `waynes-worlding-content` | PASS | 65px | 6.0px | 1.6476% | 6.708% | recorded: pass |
| `bill-and-ted-ing-crm` | PASS | 64px | 9.849px | 2.0024% | 3.4531% | recorded: pass |
| `robocopping-offers` | PASS | 64px | 11.692px | 3.758% | 8.2765% | recorded: pass |
...
Full-size contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/rambo-ing-manager-source-full.png`

128px contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/rambo-ing-manager-source-128.png`

GIF contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/rambo-ing-manager-gif-128.png`
...
|---:|---:|---:|---:|---|
| 0 | 65px | 49343px | 1 (1/0) | none |
| 1 | 65px | 49286px | 1 (1/0) | none |
| 2 | 65px | 49006px | 1 (1/0) | none |
| 3 | 65px | 49049px | 1 (1/0) | none |

| Transition | Mask XOR | Silhouette p95 | Centroid | Registration shift | Residual | Upper NCC |
|---:|---:|---:|---:|---:|---:|---:|
| 0→1 | 1.6271% | 7.0px | 0.171px | 0.0px | 2.5182% | 0.9958 |
| 1→2 | 1.2777% | 7.211px | 0.561px | 0.0px | 2.7051% | 0.9894 |
| 2→3 | 0.5066% | 4.38px | 0.048px | 0.0px | 2.4597% | 0.9923 |
...
Full-size contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/godfathering-reports-source-full.png`

128px contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/godfathering-reports-source-128.png`

GIF contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/godfathering-reports-gif-128.png`
...
| Cell | Margin | Foreground | Components (significant/tiny) | Artifact flags |
|---:|---:|---:|---:|---|
| 0 | 65px | 40900px | 1 (1/0) | none |
| 1 | 65px | 40900px | 1 (1/0) | none |
| 2 | 65px | 40900px | 1 (1/0) | none |
| 3 | 65px | 40900px | 1 (1/0) | none |

| Transition | Mask XOR | Silhouette p95 | Centroid | Registration shift | Residual | Upper NCC |
|---:|---:|---:|---:|---:|---:|---:|
| 0→1 | 0.0% | 0.0px | 0.0px | 0.0px | 0.2616% | 0.9966 |
| 1→2 | 0.0% | 0.0px | 0.0px | 0.0px | 0.379% | 0.9908 |
| 2→3 | 0.0% | 0.0px | 0.0px | 0.0px | 0.313% | 0.9922 |
...
Required action: The two connected distal forearms counter-rotate around fixed elbows over one bent-knee dance plate; the Reports face, bob, torso, pelvis, legs and shoes remain fixed.

Full-size contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/pulp-fictioning-reports-source-full.png`

128px contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/pulp-fictioning-reports-source-128.png`

GIF contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/pulp-fictioning-reports-gif-128.png`

Failures: none

Warnings: `BBOX_SCALE_OR_PROP_JUMP`

Manual notes: The black bob is a costume, while the canonical female Reports face, proportions and ink/wash medium stay recognizable. Both connected forearms articulate in opposite directions for a readable twist gesture; face, bob, torso, pelvis, legs and shoes are exact across all phases. Fixed elbow overlaps prevent holes or duplicate limbs. No morph, camera motion, debris, crop or shimmer.

| Cell | Margin | Foreground | Components (significant/tiny) | Artifact flags |
|---:|---:|---:|---:|---|
| 0 | 65px | 50954px | 1 (1/0) | none |
| 1 | 65px | 50978px | 1 (1/0) | none |
| 2 | 65px | 51358px | 1 (1/0) | none |
| 3 | 65px | 51129px | 1 (1/0) | none |

| Transition | Mask XOR | Silhouette p95 | Centroid | Registration shift | Residual | Upper NCC |
|---:|---:|---:|---:|---:|---:|---:|
| 0→1 | 3.4515% | 7.148px | 0.31px | 0.0px | 6.8433% | 0.9997 |
| 1→2 | 5.1337% | 11.402px | 1.753px | 0.0px | 8.7212% | 1.0 |
| 2→3 | 3.0914% | 7.071px | 1.037px | 0.0px | 6.7092% | 1.0 |

| Stationary region | Max change | Allowed |
|---|---:|---:|
| fixed-reports-dance-lower-body | 0.0% | 0.0% |
| fixed-reports-bob-face-and-torso | 0.0% | 0.0% |
...
Full-size contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/waynes-worlding-content-source-full.png`

128px contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/waynes-worlding-content-source-128.png`

GIF contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/waynes-worlding-content-gif-128.png`
...
| Transition | Mask XOR | Silhouette p95 | Centroid | Registration shift | Residual | Upper NCC |
|---:|---:|---:|---:|---:|---:|---:|
| 0→1 | 0.8991% | 3.362px | 0.304px | 0.0px | 5.3415% | 0.8904 |
| 1→2 | 1.6476% | 6.0px | 0.455px | 0.0px | 6.708% | 0.8442 |
| 2→3 | 0.7104% | 3.0px | 0.227px | 0.0px | 4.9673% | 0.9117 |
...
Full-size contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/bill-and-ted-ing-crm-source-full.png`

128px contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/bill-and-ted-ing-crm-source-128.png`

GIF contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/bill-and-ted-ing-crm-gif-128.png`
...
| 2→3 | 1.201% | 5.657px | 0.357px | 0.0px | 2.6299% | 0.9968 |

| Stationary region | Max change | Allowed |
|---|---:|---:|
| fixed-crm-face-torso-left-core | 0.0% | 0.0% |
...
Full-size contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/robocopping-offers-source-full.png`

128px contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/robocopping-offers-source-128.png`

GIF contact: `qa/strict-repairs/movie-style-canonical-six/report-production/contacts/robocopping-offers-gif-128.png`
...
| Stationary region | Max change | Allowed |
|---|---:|---:|
| fixed-offers-armour-core-right-side | 0.0% | 0.0% |
