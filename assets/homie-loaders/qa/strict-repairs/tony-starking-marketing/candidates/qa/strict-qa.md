...
Full-size contact: `assets/homie-loaders/qa/strict-repairs/tony-starking-marketing/candidates/qa/contacts/tony-starking-marketing-source-full.png`

128px contact: `assets/homie-loaders/qa/strict-repairs/tony-starking-marketing/candidates/qa/contacts/tony-starking-marketing-source-128.png`

GIF contact: `assets/homie-loaders/qa/strict-repairs/tony-starking-marketing/candidates/qa/contacts/tony-starking-marketing-gif-128.png`

Failures: none

Warnings: none

Manual notes: Inspected all four 627px authored cells, all four 128px cells, and the six-frame GIF contact. Exactly one palm emitter and one chest reactor pulse in place; canonical face, five-finger gauntlet, relaxed armored hand, body, crop, and scale remain stable.
