...
- `homie-loaders-runtime.zip`: compact implementation package.
- `references/`: canonical Homies character art.
- `scripts/`: repeatable assembly, verification, and preview tooling.
- `vercel-site/`: the static site deployed to Vercel.

All GIFs are 256×256, infinitely looping, and matted for the Homies AI
`#FBF9F6` canvas while retaining transparent backgrounds.

The Teamwork collection contains 28 Manager-plus-specialist handoffs, tag-ins,
